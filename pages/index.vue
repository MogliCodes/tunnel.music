<template>
  <main>
    ...
    <div class="relative flex flex-col gap-8 md:gap-12 items-start z-20 w-full lg:w-7/12">
      <h1 class="font-display sm:text-5xl lg:text-8xl uppercase">music for getting into the tunnel</h1>
      <div class="md:w-1/2">
