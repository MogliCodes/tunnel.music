<template>
  <main>
    ...
    <div class="relative flex flex-col gap-8 md:gap-12 items-start z-20 md:w-7/12">
      <h1 class="font-display md:text-8xl uppercase">music for getting into the tunnel</h1>
      <div class="md:w-1/2">
